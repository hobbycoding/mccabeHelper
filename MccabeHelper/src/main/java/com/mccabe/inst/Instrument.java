...
public class Instrument extends McCabeConfig {
    ...
    public void pcfCreate(File file) throws Exception {
        ...
        try {
            ...
            fw.append(System.getProperty("line.separator") + "INSTOUT " + TRACEFILE_HOME  + fs + property.getProperty("programName") + fs + property.getProperty("projectName") + "_" + property.getProperty("fileName") + "_inst.out");
